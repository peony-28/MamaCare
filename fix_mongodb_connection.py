...
print(f"\n   Example format:")
print(f"   MONGODB_HOST=mongodb+srv://<username>:<password>@<cluster>.mongodb.net/mamacare_db?retryWrites=true&w=majority")
print(f"   (Replace <username>, <password>, and <cluster> with your actual values)")
print(f"\n   Also verify:")
